...
export const LINES = {
  ...
  firewolf_howto: { voice: 'pip', text: 'You can be the Fire Wolf now! HOLD the wolf button at the bottom to pick him. Then try the ground-slam!' },
  ...
  earthwolf_howto: { voice: 'pip', text: 'You can be the Earth Wolf now! HOLD the wolf button at the bottom to pick him. His stomp smashes cracked rock!' },
  ...
  verdant_howto: { voice: 'pip', text: 'You can be the Verdant Wolf now! HOLD the wolf button at the bottom to pick him. His vine-lash CUTS thorn tangles — try that one right there!' },
