...
const FORM_ORDER = ['knight', 'dark_wolf', 'fire_wolf', 'earth_wolf', 'verdant_wolf', 'frost_wolf', 'storm_wolf'];
...
export class UI {
  ...
  refreshBadge() {
    ...
    this.specialIcon.textContent =
      { knight: '🌀', fire_wolf: '🔥', earth_wolf: '🪨', verdant_wolf: '🌿', frost_wolf: '❄️', storm_wolf: '🌩️' }[state.form] || '🌙';
