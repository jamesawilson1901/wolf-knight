...
// ---------------------------------------------------------------------------
// FROSTPEAK (region 4) lives in js/level4.js since 2026-09-03 — the last
// region to leave this file. The v3.21 hand-build (seven rooms, buildSnowShell,
// the frost gate, the ice sheet, the frost bramble) moved there whole, rebuilt
// at module scale on the shared shell/door/dresser vocabulary, keeping every
// room id, world-state key, plate id and the Frozen Lake's stopper arithmetic
// to the decimal.
