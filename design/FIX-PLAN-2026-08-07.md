> **ARCHIVED 2026-08-09.** This is the levels 1-3 audit, every item shipped by
> v3.34.0. BUILDLOG's references to A1-A9, B1-B3 and C1-C4 mean the items in
> THIS file. The live plan is `design/FIX-PLAN.md`, which audits Stormreach
> Cliffs and the Sunken Vale and starts a fresh ID space.
