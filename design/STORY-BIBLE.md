...
3. Wild Woods — Sylva, growth — VERDANT WOLF (vine-lash: snares foes,
   cuts brambles; aura: drifting leaves)
4. Frostpeak — Boreal, ice — FROST WOLF (ice-howl freezes water and
   enemies; aura: icicles + cold mist)
5. Stormreach Cliffs — Aria, sky — STORM WOLF (thunder-dash; aura:
   white lightning)
6. Sunken Vale — Meri, water — TIDE WOLF (bubble-shield water-walk;
   aura: droplets)
...
per region (escalating doubt). Luna dreams once per region end (comfort +
destination). Each spirit speaks exactly twice: freed + gift.
