...
const SECTIONS = [
  ...
  ['Ember Hollow — ruined and sad', 'Level 1 · somewhere people LIVED before it burned.', [
    ...
    ['lk1', 'THE UNDERSTAIR — Ember Deep, optional: fire opens the way'],
    ['lk2', 'THE CHARRED SPAN — Ember Deep, optional: the crossing'],
    ['lk3', 'THE BANKED FIRE — Ember Deep, optional: light the ring, a vault door opens'],
    ['lk4', 'THE KINDLED HOARD — Ember Deep, the ring\'s reward: 6 chests'],
